...
helpers do
  ...
  def flag_as_abuse(obj)
    ...
    obj.author.update_stats_for_course(obj.course_id, active_flags: 1) unless obj.abuse_flaggers.empty?
  ...
  def un_flag_as_abuse(obj)
    ...
    if params["all"]
      ...
      obj.author.update_stats_for_course(obj.course_id, inactive_flags: 1) unless obj.historical_abuse_flaggers.empty?
